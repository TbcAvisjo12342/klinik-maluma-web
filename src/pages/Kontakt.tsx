          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-4xl mx-auto">
            ...
            <div className="rounded-xl overflow-hidden border h-80 md:h-auto md:min-h-[400px]">
              <iframe
                ...
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1129!2d11.7985!3d55.3065!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zKlinik+Maluma!5e0!3m2!1sda!2sdk!4v1&q=Klinik+Maluma+Sibberupvej+13+Holmegaard"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
